<template>
    <div class="content project">
        ...
        <div id="text" class="p-text">
            ...
            <a href="https://chrome.google.com/webstore/detail/modern-myneu/phpjhjbppfdgofldhpecojjdfccboblk">
...
.project {
    .p-heading {
        background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('~@assets/img/myneu.jpg') no-repeat;
    }
    .p-text {
        .block-1 {
            width: 40%;
