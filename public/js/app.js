...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_analytics__ = __webpack_require__(85);
...
var uaKey = document.head.querySelector("[name=ua-google-key]").content;
if (uaKey && uaKey !== '') {
...
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(86)) :
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h2', [_vm._v("A little bit about me...")]), _vm._v(" "), _c('p', [_vm._v("\n                        Hi! I’m Peter Abbondanzo, " + _vm._s(_vm.getAge()) + "-year-old UI/UX designer of web and mobile applications. Currently, I am studying at "), _c('a', {
    staticClass: "under",
    attrs: {
      "href": "http://www.northeastern.edu/",
      "title": "Northeastern"
    }
  }, [_vm._v("Northeastern University")]), _vm._v(" up in Boston, Massachusetts. I’ve got a passion for creating, innovating, and coffee. I also run this small company called "), _c('a', {
    staticClass: "under",
    attrs: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        projectCheck: function projectCheck(arg) {
            ...
            var newImg = __webpack_require__(105)("./" + this.projects[arg].image);
            this.$nextTick(function () {
                this.img = newImg;
            });
        },
...
var map = {
	"./backgrounds/bg1.jpg": 106,
	"./backgrounds/bg2.jpg": 107,
	"./backgrounds/bg3.jpg": 108,
	"./backgrounds/bg4.jpg": 109,
	"./backgrounds/bg5.jpg": 110,
	"./backgrounds/bg6.jpg": 111,
	"./bg.jpg": 7,
	"./bonne/b1.jpg": 21,
	"./bonne/b2.jpg": 22,
	"./bonne/b3.jpg": 23,
	...
	"./flipster/f3.jpg": 28,
	"./flipster/f4.jpg": 29,
	"./fullsize_images/bg.png": 112,
	"./fullsize_images/fullbvc.png": 113,
	"./fullsize_images/fullflipster.png": 114,
	"./fullsize_images/fullmyneu.png": 115,
	"./fullsize_images/fullrogue.png": 116,
	"./fullsize_images/fullsth.png": 117,
	"./fullsize_images/logo_small_black.png": 118,
	"./fullsize_images/logo_small_white.png": 119,
	"./fullsize_images/peter.png": 120,
	"./logo.svg": 19,
	"./myneu.jpg": 10,
	"./myneu/m1.jpg": 30,
	"./myneu/m1.png": 31,
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-2d038645] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(8) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(8) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-2d038645] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-2d038645] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-2d038645]:last-child {\n  margin-top: -300px;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: "p-title"
  }, [_c('h1', [_vm._v("Bonne Vie Café")]), _vm._v(" "), _c('h4', [_vm._v("Simple cafe web-page mockup.")])])]), _vm._v(" "), _c('div', {
    staticClass: "p-text",
    attrs: {
      "id": "text"
    }
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-0af0c3e7] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(11) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(11) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-0af0c3e7] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-0af0c3e7] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-0af0c3e7]:last-child {\n  margin-top: -300px;\n}\n.project .p-text .image-slider[data-v-0af0c3e7] {\n  margin-bottom: 40px;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            imageArray: [__webpack_require__(35), __webpack_require__(36), __webpack_require__(37), __webpack_require__(38)]
        };
    },
    components: {
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-83cd1624] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(9) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(9) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-83cd1624] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-83cd1624] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-83cd1624]:last-child {\n  margin-top: -300px;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-1859053e] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(4) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(4) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-1859053e] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-1859053e] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-1859053e]:last-child {\n  margin-top: -300px;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-3e5db604] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(12) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(12) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-3e5db604] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-3e5db604] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-3e5db604]:last-child {\n  margin-top: -300px;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.project .p-heading[data-v-66415640] {\n  background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.8)), to(rgba(0, 0, 0, 0.8))), url(" + __webpack_require__(10) + ") no-repeat;\n  background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(" + __webpack_require__(10) + ") no-repeat;\n}\n.project .p-text .block-1[data-v-66415640] {\n  width: 40%;\n  margin: 80px 20% 0 10%;\n}\n.project .p-text .block-2[data-v-66415640] {\n  width: 60%;\n  margin: 100px 0 0 30%;\n}\n.project .p-text p[data-v-66415640]:last-child {\n  margin-top: -300px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate__ = __webpack_require__(160);
