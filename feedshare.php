    ...
    <div class="item-view container animate fade-in-up">
        <div>
            <left class="lr-content">
                ...
                <img src="img/660pxfeedshare1.png">
            </right>
        </div>
        <div>
            <left>
                <img src="img/660pxfeedshare2.png">
        ...
        <div class="switch">
            <right>
                <img src="img/660pxfeedshare3.png">
                ...
                <a target="_blank" href="http://feedshare.org/"><button class="btn">View App</button></a>
            </left>
        </div>
