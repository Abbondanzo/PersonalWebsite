...
export default {
    ...
    methods: {
        track: function(e) {
            if (this.mouseDown) {
                var sliderWidth = document.querySelector('.image-slider')
                    .offsetWidth
        ...
        shiftPosition: function() {
            ...
            var offset =
                parseInt(
                    (imgWidth /
                        document.querySelector('.image-slider').offsetWidth) *
                        100
                ) + 1
        ...
        moveLeft: function() {
            ...
            if (newActive >= this.images.length) {
                newActive =
                    (newActive + this.images.length) % this.images.length
            }
